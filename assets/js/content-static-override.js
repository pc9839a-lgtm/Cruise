(function () {
  ...
  const newItems = [
    { content_id:'cruise-casino-onboard-guide', title:'크루즈 카지노는 어떻게 이용할까? 운영시간·현금·복장 가이드', category:'선내생활', summary:'크루즈 카지노의 운영시간, 연령 제한, 현금과 선상계정 사용, 복장, 흡연구역, 예산 관리와 초보 이용 순서를 정리했습니다.', thumbnail_url:'https://images.unsplash.com/photo-1511512578047-dfb367046420?q=80&w=1600&auto=format&fit=crop', link_url:'/blog/cruise-casino-onboard-guide/', tag_text:'크루즈카지노', published_at:'2026-07-25' },
    { content_id:'cruise-spa-massage-thermal-suite-guide', title:'크루즈 스파는 어떻게 이용할까? 마사지·써멀스위트·예약 가이드', category:'선내생활', summary:'크루즈 스파의 마사지와 페이셜, 써멀스위트 이용권, 예약 시간, 자동 팁, 취소 조건과 상품 권유 대응 방법을 정리했습니다.', thumbnail_url:'https://images.unsplash.com/photo-1540555700478-4be289fbecef?q=80&w=1600&auto=format&fit=crop', link_url:'/blog/cruise-spa-massage-thermal-suite-guide/', tag_text:'크루즈스파', published_at:'2026-07-25' },
