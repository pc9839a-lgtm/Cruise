  ...
  function addStyles() {
    ...
    style.textContent = `
      ...
      @media(max-width:780px){
        ...
        #real-booking-case{padding:72px 0}.pmx-case-route{font-size:21px}.pmx-case-features{grid-template-columns:1fr;margin-top:34px}.pmx-case-features div{min-height:86px;padding:18px 12px;font-size:22px}.pmx-case-features div+div{border-left:0;border-top:1px solid #d9e0ea}.pmx-case-prices{grid-template-columns:1fr;margin-top:34px}.pmx-case-price{padding:18px 10px;border-top:1px solid #d9e0ea}.pmx-case-price:first-child{border-top:0}.pmx-case-price span{font-size:19px}.pmx-case-price strong{font-size:46px}
