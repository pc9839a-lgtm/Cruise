(() => {
  ...
  function addStyles() {
    ...
    style.textContent = `
      ...
      .ig5-result-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:14px}
      .ig5-result-box{padding:30px 16px;border-radius:26px;background:#f5f7fb}
      .ig5-result-box span{display:block;font-size:clamp(21px,2.3vw,27px);font-weight:500}
      .ig5-result-box strong{display:block;margin-top:14px;font-size:clamp(38px,4.7vw,58px);line-height:1;font-weight:880;letter-spacing:-.05em}
      ...
      .ig5-reveal.is-visible .ig5-route:nth-child(4){opacity:1;transform:none;transition-delay:.48s}
      ...
      @media(max-width:780px){
        ...
        .ig5-result{padding:30px 18px}.ig5-result-grid{grid-template-columns:1fr;gap:10px}.ig5-result-box{padding:24px 12px}.ig5-result-box span{font-size:21px}.ig5-result-box strong{font-size:38px}
        ...
        .ig5-checks{grid-template-columns:1fr;gap:12px}.ig5-check{font-size:27px;padding:28px 20px}.ig5-btn{width:100%}
      }
      @media(max-width:420px){.ig5-title{font-size:36px}.ig5-mega{font-size:76px}.ig5-routes{gap:8px}.ig5-route{padding:22px 12px}.ig5-route h3{font-size:23px}.ig5-route-price{font-size:29px}.ig5-route-flow{font-size:17px}.ig5-route-flow strong{font-size:21px}}
  ...
  function inject() {
    ...
    const html =
      ...
      + section('ig5-start','ig5-white',`
        <span class="ig5-kicker">첫 가입부터 시작</span>
        <h2 class="ig5-title">클래식 시작 비용 <strong>$200</strong><br>가입 리워드 <strong>350P</strong></h2>
        <div class="ig5-pair">
          <div class="ig5-pair-card"><span>시작 비용</span><strong>$200</strong></div>
          <div class="ig5-symbol">→</div>
          <div class="ig5-pair-card"><span>가입 리워드</span><strong class="ig5-accent">350P</strong></div>
        </div>`)
      ...
      + section('ig5-seven','ig5-dark',`
        <span class="ig5-kicker">7개월을 준비하면</span>
        <h2 class="ig5-title">포인트가 정확히<br><strong>1,750P</strong>가 됩니다</h2>
        <div class="ig5-ledger">
          <div class="ig5-ledger-row"><span>가입 리워드</span><strong>350P</strong></div>
          <div class="ig5-ledger-row"><span>7개월 × 매월 200P</span><strong>1,400P</strong></div>
          <div class="ig5-ledger-row total"><span>총 보유 포인트</span><strong data-count="1750" data-suffix="P">1,750P</strong></div>
        </div>`)
      + section('ig5-cruise','ig5-soft',`
        <span class="ig5-kicker">예를 들어</span>
        <h2 class="ig5-title"><strong>$3,500</strong>짜리 크루즈를<br>예약한다고 가정해보겠습니다</h2>
        <div class="ig5-mega" data-count="3500" data-prefix="$">$3,500</div>`)
      + section('ig5-payment','ig5-blue',`
        <span class="ig5-kicker">보유 포인트를 전부 사용</span>
        <h2 class="ig5-title"><strong>1,750P</strong> 사용하고<br>나머지 <strong>$1,750</strong>만 카드로</h2>
        <div class="ig5-pair">
          <div class="ig5-pair-card"><span>포인트 사용</span><strong data-count="1750" data-suffix="P">1,750P</strong></div>
          <div class="ig5-symbol">+</div>
          <div class="ig5-pair-card"><span>카드 결제</span><strong data-count="1750" data-prefix="$">$1,750</strong></div>
        </div>
        <div class="ig5-mega-note">사용 후 남는 포인트 <strong>0P</strong></div>`)
      + section('ig5-real','ig5-white',`
        <span class="ig5-kicker">그래서 실제 지출은</span>
        <h2 class="ig5-title">$3,500 크루즈를<br><strong>$2,650</strong>에 준비한 셈입니다</h2>
        <div class="ig5-result">
          <div class="ig5-result-grid">
            <div class="ig5-result-box"><span>시작 비용</span><strong>$200</strong></div>
            <div class="ig5-result-box"><span>7개월 납부</span><strong>$700</strong></div>
            <div class="ig5-result-box"><span>예약 카드 결제</span><strong>$1,750</strong></div>
          </div>
          <div class="ig5-saving"><strong data-count="2650" data-prefix="$">$2,650</strong><span>$3,500 대비 <strong>$850 절감</strong><br>실지출 약 <strong>24.3% 감소 ≈ 25%</strong></span></div>
        </div>`)
      + section('ig5-routes','ig5-soft',`
        <span class="ig5-kicker">가격대가 달라도 원리는 같습니다</span>
        <h2 class="ig5-title">대표 크루즈 4가지<br><strong>한눈에 비교</strong></h2>
        <div class="ig5-routes">
          <article class="ig5-route"><h3>아시아</h3><span class="ig5-route-price">$1,900</span><div class="ig5-route-flow">3개월 준비 · 950P 전부 사용<strong>$1,450 실지출</strong></div><span class="ig5-route-save">$450 절감 · 잔여 0P</span></article>
          <article class="ig5-route"><h3>지중해</h3><span class="ig5-route-price">$3,500</span><div class="ig5-route-flow">7개월 준비 · 1,750P 전부 사용<strong>$2,650 실지출</strong></div><span class="ig5-route-save">$850 절감 · 잔여 0P</span></article>
          <article class="ig5-route"><h3>북유럽</h3><span class="ig5-route-price">$4,300</span><div class="ig5-route-flow">9개월 준비 · 2,150P 전부 사용<strong>$3,250 실지출</strong></div><span class="ig5-route-save">$1,050 절감 · 잔여 0P</span></article>
          <article class="ig5-route"><h3>디즈니</h3><span class="ig5-route-price">$5,100</span><div class="ig5-route-flow">11개월 준비 · 2,550P 전부 사용<strong>$3,850 실지출</strong></div><span class="ig5-route-save">$1,250 절감 · 잔여 0P</span></article>
        </div>`)
