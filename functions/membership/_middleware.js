    ...
    .on('body', {
      element(element) {
        element.append(
          ...
          '<script defer src="/membership/membership-travel-expansion-v1.js?v=20260903-travel48"></script>' +
          '<script defer src="/membership/membership-section21-22-terms-final-v1.js?v=20260903-flow36"></script>' +
          '<script defer src="/membership/membership-live-motion-v1.js?v=20260903-live48"></script>' +
