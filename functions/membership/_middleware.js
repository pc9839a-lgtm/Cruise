export async function onRequest(context) {
  ...
  const canonicalStyle = '<link rel="stylesheet" href="/membership/membership-canonical-v5.css?v=20260903-bridge69">';
    ...
    .on('body', {
      element(element) {
        element.append(
          ...
          '<script defer src="/membership/membership-section6-price-barrier-v1.js?v=20260903-flow22"></script>' +
          '<script defer src="/membership/membership-section7-8-price-proof-v1.js?v=20260903-flow22"></script>' +
          '<script defer src="/membership/membership-section9-10-cost-use-v1.js?v=20260903-flow22"></script>' +
          ...
          '<script defer src="/membership/membership-partner-motion-v1.js?v=20260903-flow22"></script>' +
