    ...
    .on('body', {
      element(element) {
        element.append(
          ...
          '<script defer src="/membership/membership-section7-8-price-proof-v1.js?v=20260903-flow27"></script>' +
          '<script defer src="/membership/membership-section9-10-cost-use-v1.js?v=20260903-flow22"></script>' +
          '<script defer src="/membership/membership-section11-12-guide-transition-v1.js?v=20260903-flow26"></script>' +
          ...
          '<script defer src="/membership/membership-partner-motion-v1.js?v=20260903-flow27"></script>' +
