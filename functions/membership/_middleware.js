export async function onRequest(context) {
  ...
  return new HTMLRewriter()
    ...
    .on('script[src*="membership-calc-plans-v2.js"]', {
      element(element) { element.setAttribute('src', '/membership/membership-calc-plans-v2.js?v=20260905-plan72'); }
    })
    ...
    .on('body', {
      element(element) {
        element.append(
          ...
          '<script defer src="/membership/membership-section3-port-v1.js?v=20260911-v3s05-ingroup1"></script>' +
          '<script defer src="/membership/membership-section4-moving-hotel-v1.js?v=20260911-v3s06"></script>' +
          '<script defer src="/membership/membership-impact-flow-v1.js?v=20260911-v3s07"></script>' +
          '<script defer src="/membership/membership-section6-price-barrier-v1.js?v=20260903-flow23"></script>' +
          '<script defer src="/membership/membership-section7-8-price-proof-v1.js?v=20260911-v3s07-compat1"></script>' +
