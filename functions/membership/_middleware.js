...
const POLISH_SCRIPT = '<script src="/membership/membership-polish-v9.js?v=20260830-4"></script>';

class MembershipScriptInjector {
  element(element) {
    element.prepend(SURVEY_SCRIPT + CONVERSION_SCRIPT + POLISH_SCRIPT, { html: true });
  }
}
