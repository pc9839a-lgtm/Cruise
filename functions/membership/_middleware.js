export async function onRequest(context) {
  ...
  const canonicalStyle = '<link rel="stylesheet" href="/membership/membership-canonical-v5.css?v=20260903-unified19">';
    ...
    .on('body', {
      element(element) {
        element.append(
          ...
          '<script defer src="/membership/membership-section21-22-terms-final-v1.js?v=20260903-flow19"></script>' +
          '<script defer src="/membership/membership-hero-restore-v1.js?v=20260902-subscription-restore"></script>' +
          '<script defer src="/membership/membership-partner-motion-v1.js?v=20260903-flow19"></script>' +
