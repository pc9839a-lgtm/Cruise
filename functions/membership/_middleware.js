    ...
    .on('body', {
      element(element) {
        element.append(
          ...
          '<script defer src="/membership/membership-section-order-fix-v1.js?v=20260905-order64"></script>' +
          '<script defer src="/membership/membership-refund-assurance-v1.js?v=20260905-refund64"></script>' +
