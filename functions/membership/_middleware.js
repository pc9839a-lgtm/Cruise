export async function onRequest(context) {
  ...
  const impactStyle = '<link rel="stylesheet" href="/membership/membership-impact-flow-v1.css?v=20260901-step4cards">';
    ...
    .on('body', {
      element(element) {
        element.append(
          ...
          '<script defer src="/membership/membership-impact-flow-v1.js?v=20260901-step4cards"></script>' +
