export async function onRequest(context) {
  ...
  const liveMotionStyle = '<link rel="stylesheet" href="/membership/membership-live-motion-v1.css?v=20260903-live41">';
    ...
    .on('body', {
      element(element) {
        element.append(
          ...
          '<script defer src="/membership/membership-live-motion-v1.js?v=20260903-live41"></script>' +
