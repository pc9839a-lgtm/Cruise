export async function onRequest(context) {
  ...
  const liveMotionStyle = '<link rel="stylesheet" href="/membership/membership-live-motion-v1.css?v=20260903-live40">';
    ...
    .on('body', {
      element(element) {
        element.append(
          ...
          '<script defer src="/membership/membership-cruise-example-images-v1.js?v=20260903-cruiseimages2"></script>' +
          '<script defer src="/membership/membership-section13-14-points-v1.js?v=20260903-flow24"></script>' +
          '<script defer src="/membership/membership-section15-16-point-payment-v1.js?v=20260903-flow39"></script>' +
          ...
          '<script defer src="/membership/membership-live-motion-v1.js?v=20260903-live40"></script>' +
