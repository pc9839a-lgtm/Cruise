export async function onRequest(context) {
  ...
  const calcStyle = '<link rel="stylesheet" href="/membership/membership-calc-plans-v2.css?v=20260903-unifiedcalc14">';
    ...
    .on('body', {
      element(element) {
        element.append(
          ...
          '<script defer src="/membership/membership-section17-18-calculator-fit-v1.js?v=20260903-originalusd14"></script>' +
          ...
          '<script defer src="/membership/membership-partner-motion-v1.js?v=20260903-flow17"></script>' +
