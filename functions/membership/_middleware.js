export async function onRequest(context) {
  ...
  const canonicalStyle = '<link rel="stylesheet" href="/membership/membership-canonical-v2.css?v=20260902-2">';
    ...
    .on('body', {
      element(element) {
        element.append(
          ...
          '<script defer src="/membership/membership-canonical-motion-v2.js?v=20260902-2"></script>',
          { html: true }
        );
      }
    })
